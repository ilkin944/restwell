      ...
      content = (
        <View style={Styles.flex}>
          <ImageSlider
            ...
            style={Styles.flex}
            paginationStyle={styles.sliderDotFood64}
          />
          ...
          {product.videoURL && (
            <View style={styles.videoActionsFood}>
              <TouchableOpacity
      ...
      return (
        <View style={Styles.paddingHorizontal16}>
          <View
            ...
            <View style={[Styles.flex, Styles.padding8]}>
              <Text typography="h4" weight="bold">
                {product?.title}
              </Text>
              <SizedBox height={4} />
              <Text typography="subtitle" weight="semibold" color="secondary">
            ...
            <View style={Styles.columnSpaceRight}>
